...
<img src="/react/react-hook1/1.png" className={`max-w-full h-auto`}></img>
...
<img src="/react/react-hook1/2.png" className={`max-w-full h-auto`}></img>
...
<img src="/react/react-hook1/3.png" className={`max-w-full h-auto`}></img>
...
<img src="/react/react-hook1/4.PNG" className={`max-w-full h-auto`}></img>
...
<img src="/react/react-hook1/5.png" className={`max-w-full h-auto`}></img>

2. 부모 컴포넌트에서 전역변수를 선언한다.

<img src="/react/react-hook1/6.png" className={`max-w-full h-auto`}></img>

3. 자식 컴포넌에서 전역변수를 가져와서 사용한다.

<img src="/react/react-hook1/7.png" className={`max-w-full h-auto`}></img>
