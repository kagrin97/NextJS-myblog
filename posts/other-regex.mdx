...
<img src="/other-regex/1.PNG" className={`max-w-full h-auto`}></img>
...
<img src="/other-regex/2.PNG" className={`max-w-full h-auto`}></img>
...
<img src="/other-regex/3.PNG" className={`max-w-full h-auto`}></img>
...
<img src="/other-regex/4.PNG" className={`max-w-full h-auto`}></img>
...
<img src="/other-regex/5.PNG" className={`max-w-full h-auto`}></img>
...
<img src="/other-regex/6.PNG" className={`max-w-full h-auto`}></img>
